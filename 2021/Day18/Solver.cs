...
[1,1]").ToString() == "[[[[0,7],4],[[7,8],[6,0]]],[8,1]]");
        ...
        Debug.Assert(Magnitude(Reduce("[[1,2],[[3,4],5]]")) == 143);
        Debug.Assert(Magnitude(Reduce("[[[[0,7],4],[[7,8],[6,0]]],[8,1]]")) == 1384);
        Debug.Assert(Magnitude(Reduce("[[[[1,1],[2,2]],[3,3]],[4,4]]")) == 445);
        Debug.Assert(Magnitude(Reduce("[[[[3,0],[5,3]],[4,4]],[5,5]]")) == 791);
        Debug.Assert(Magnitude(Reduce("[[[[5,0],[7,4]],[5,5]],[6,6]]")) == 1137);
        Debug.Assert(Magnitude(Reduce("[[[[8,7],[7,7]],[[8,6],[7,7]]],[[[0,7],[6,6]],[8,7]]]")) == 3488);
        Debug.Assert(Magnitude(Reduce("[[[[6,6],[7,6]],[[7,7],[7,0]]],[[[7,7],[7,7]],[[7,8],[9,9]]]]")) == 4140);
...
[[[[5,2],5],[8,[3,7]]],[[5,[7,5]],[4,4]]]").ToString() == "[[[[6,6],[7,6]],[[7,7],[7,0]]],[[[7,7],[7,7]],[[7,8],[9,9]]]]");
        ...
        Debug.Assert(Solve(@"[[[0,[5,8]],[[1,7],[9,6]]],[[4,[1,2]],[[1,4],2]]]
[[[5,[2,8]],4],[5,[[9,9],0]]]
[6,[[[6,2],[5,6]],[[7,6],[4,7]]]]
[[[6,[0,7]],[0,9]],[4,[9,[9,0]]]]
[[[7,[6,4]],[3,[1,3]]],[[[5,5],1],9]]
    ...
    public string Solve(string input)
    {
        ...
        for (int x = 0; x < numbers.Length; x++)
        {
            for (int y = 0; y < numbers.Length; y++)
            {
                ...
                result = Math.Max(result, Magnitude(Reduce(Parse(numbers[x]) + Parse(numbers[y]))));
            }
        }
